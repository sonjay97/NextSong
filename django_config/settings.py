"""
Django settings for nextsong project.
...
SECRET_KEY = 'django-insecure-5=@tif_^q0^_az5^rq7!qe+88wpmi)qlb2e0r&n+0=7vh_a^=4'
...
# Hosts (localhost for dev; set ALLOWED_HOSTS env when deployed)
